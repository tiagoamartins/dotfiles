...
" Only load this indent file if not yet done for this buffer
if exists("b:did_indent")
    finish
endif

" Don't load any other indent file for this buffer
let b:did_indent = 1
...
if !exists("g:vhdl_indent_ports")
    let g:vhdl_indent_ports = 1
endif

" Option to disable alignment of right-hand side assignment "<=" statements
if !exists("g:vhdl_indent_assign")
    let g:vhdl_indent_assign = 1
endif

" Don't define indent function twice
...
" Setup indent options for VHDL files
